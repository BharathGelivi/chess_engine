...
const engineNames: Record<EngineKind, string> = { stockfish: 'Stockfish 18', ours: 'BOARDROOM Engine' }
        ...
        <aside className="analysis-panel">
          {mode === 'analysis' ? (
            <>
              ...
              <div className="engine-picker"><span className="label">ENGINE</span><div className="engine-picker-buttons"><button className={engineChoice === 'stockfish' ? 'active-move' : ''} onClick={() => setEngineChoice('stockfish')}>Stockfish 18</button><button className={engineChoice === 'ours' ? 'active-move' : ''} onClick={() => setEngineChoice('ours')}>BOARDROOM Engine</button></div></div>
